...
namespace Yavsc.Migrations
{
    ...
    [Migration("20210530213408_mailling-not-mailling-lists")]
    partial class maillingnotmaillinglists
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Yavsc.Server.Models.Access.CircleAuthorizationToFile", b =>
                {
                    b.Property<long>("CircleId");

                    b.Property<string>("FullPath");

                    b.HasKey("CircleId", "FullPath");
                });
            ...
            modelBuilder.Entity("Yavsc.Models.IT.Fixing.Bug", b =>
                {
                    b.HasOne("Yavsc.Models.IT.Evolution.Feature")
                        .WithMany()
