        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaypalPaymentPaypalPaymentId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Link_PaypalPayment_PaypalPaymentPaypalPaymentId",
                        column: x => x.PaypalPaymentPaypalPaymentId,
