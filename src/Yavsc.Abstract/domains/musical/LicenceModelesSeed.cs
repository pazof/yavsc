...
public static class LicenceModelesSeed
{
    ...
    {
        new LicenceTemplate {
            Id = 1, Nom = "CC0 1.0", EstLibre = true,
        ...
        new LicenceTemplate {
            Id = 2, Nom = "CC BY 4.0", EstLibre = true,
            PermetUsageCommercial = true, PermetModification = true,
        ...
        new LicenceTemplate {
            Id = 3, Nom = "CC BY-SA 4.0", EstLibre = true,
            PermetUsageCommercial = true, PermetModification = true,
        ...
        new LicenceTemplate {
            Id = 4, Nom = "CC BY-NC 4.0", EstLibre = false,
        ...
        new LicenceTemplate {
            Id = 5, Nom = "CC BY-NC-SA 4.0", EstLibre = false,
            PermetUsageCommercial = false, PermetModification = true,
            ExigeAttribution = true, ExigePartageAIdentique = true,
