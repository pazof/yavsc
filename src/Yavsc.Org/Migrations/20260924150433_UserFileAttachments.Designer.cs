...
namespace Yavsc.Migrations
{
    ...
    [Migration("20260924150433_UserFileAttachments")]
    partial class UserFileAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yavsc.Models.Billing.EstimateAttachedFile", b =>
                {
                    ...
                    b.ToTable("EstimateAttachedFiles");
                });
            ...
            modelBuilder.Entity("Yavsc.Models.Billing.QueryAttachedFile", b =>
                {
                    b.Property<long>("FileId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("FileId", "CommandId");

                    b.HasIndex("CommandId");

                    b.ToTable("QueryAttachedFiles");
                });
            ...
            modelBuilder.Entity("Yavsc.Models.Billing.QueryAttachedFile", b =>
                {
                    b.HasOne("Yavsc.Models.Billing.NominativeServiceCommand", "Command")
                        .WithMany()
                        .HasForeignKey("CommandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Yavsc.Models.BlogSpotPublication", b =>
                {
                    b.HasOne("Yavsc.Models.Blog.BlogPost", "Post")
                        .WithOne("Publication")
                        .HasForeignKey("Yavsc.Models.BlogSpotPublication", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
