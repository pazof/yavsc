...
namespace Yavsc.Helpers.Google.Api
{
	/// <summary>
	/// Google Calendar API client.
	/// </summary>
	public class CalendarApi : GoogleAuth 
	{
		public CalendarApi(string authType, string callBack): base(authType,callBack)
		{
		}
		/// <summary>
		...
		public CalendarEventList GetCalendar  (string calid, DateTime mindate, DateTime maxdate,string cred)
		{
			...
			string uri = string.Format (
				...
				string.Format ("?orderBy=startTime&singleEvents=true&timeMin={0}&timeMax={1}&key=" + this.ApiKey,
